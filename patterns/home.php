...
/**
 * Title: home
 * Slug: studio-bombay-twenty-six/home
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header","tagName":"header"} /-->

<!-- wp:group {"metadata":{"patternName":"studio-bombay-twenty-six/hero-section","name":"Hero Section","categories":["homepage"]},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0"}}},"layout":{"type":"default"}} -->
...
<p class="broadsheet-tag"><?php esc_html_e('Personal', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"broadsheet-tag"} -->
<p class="broadsheet-tag"><?php esc_html_e('Blog', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading letterpress" style="margin-top:1.5rem;margin-bottom:1.5rem;font-family:'Playfair Display', Georgia, serif;font-size:clamp(3rem, 6vw, 5.5rem);font-weight:900;letter-spacing:-2px;line-height:0.92"><?php esc_html_e('aditya\'s blog', 'studio-bombay-twenty-six');?></h1>
<!-- /wp:heading -->
...
<p style="font-size:1.05rem;line-height:1.75"><?php esc_html_e('I write here a few times a month. It can range from about a good movie I saw, to books I read, to learnings around open-source and WordPress.', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Once in a while I upload a few photos too in my photos section.', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/bombaypirate-twentysix-1024x572.webp" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:group {"metadata":{"patternName":"studio-bombay-twenty-six/two-column-sticky-post","name":"Two-Column-Sticky-Post","categories":["homepage"]},"layout":{"type":"constrained","contentSize":"1280px"}} -->
<div class="wp-block-group"><!-- wp:separator {"className":"is-style-wide","style":{"color":{"background":"#1C1C1C"}}} -->
<hr class="wp-block-separator has-text-color has-alpha-channel-opacity has-background is-style-wide" style="background-color:#1C1C1C;color:#1C1C1C"/>
<!-- /wp:separator -->
...
<div class="wp-block-column" style="flex-basis:55%"><!-- wp:post-terms {"term":"category","className":"category-label, broadsheet-tag","style":{"typography":{"textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|sage"},":hover":{"color":{"text":"var:preset|color|saffron"}}}}}} /-->
...
<!-- wp:group {"metadata":{"patternName":"studio-bombay-twenty-six/latest-blogs","name":"Latest-Blogs","categories":["homepage"]},"align":"full","className":"is-style-wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull is-style-wide" style="margin-top:0;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained","contentSize":"1280px"}} -->
<div class="wp-block-group"><!-- wp:separator {"className":"is-style-wide","style":{"color":{"background":"#1C1C1C"}}} -->
<hr class="wp-block-separator has-text-color has-alpha-channel-opacity has-background is-style-wide" style="background-color:#1C1C1C;color:#1C1C1C"/>
<!-- /wp:separator -->
...
<h2 class="wp-block-heading letterpress" style="font-family:'Playfair Display', Georgia, serif;font-weight:900"><?php esc_html_e('latest', 'studio-bombay-twenty-six');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"category-label","textColor":"saffron"} -->
<p class="category-label has-saffron-color has-text-color"><?php esc_html_e('from the blog', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group post-card"><!-- wp:post-terms {"term":"category","className":"category-label, broadsheet-tag","style":{"elements":{"link":{"color":{"text":"var:preset|color|sage"},":hover":{"color":{"text":"var:preset|color|saffron"}}}}},"textColor":"sage"} /-->

<!-- wp:post-title {"level":3,"isLink":true,"style":{"typography":{"fontSize":"1.35em"}},"fontFamily":"playfair"} /-->
...
<!-- wp:group {"metadata":{"patternName":"studio-bombay-twenty-six/3-column-photos","name":"3-column-photos","categories":["homepage"]},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained","contentSize":"1280px"}} -->
...
<h2 class="wp-block-heading letterpress" style="font-family:'Playfair Display', Georgia, serif;font-weight:900"><?php esc_html_e('Photos', 'studio-bombay-twenty-six');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"1rem","lineHeight":"1.7"},"spacing":{"margin":{"bottom":"2rem"}}},"textColor":"warm-gray"} -->
<p class="has-warm-gray-color has-text-color" style="margin-bottom:2rem;font-size:1rem;line-height:1.7"><?php esc_html_e('I am not a photographer, but sometimes I do take some good ones. Visit the full archiver here.', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->
