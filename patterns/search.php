...
/**
 * Title: search
 * Slug: studio-bombay-twenty-six/search
 * Inserter: no
 */
?>
...
<p style="font-size:1rem"><?php esc_html_e('No dispatches found matching your search. Try a different query or browse the archives.', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->
