...
/**
 * Title: 404
 * Slug: studio-bombay-twenty-six/404
 * Inserter: no
 */
?>
...
<p class="has-medium-font-size" style="line-height:1.75"><?php esc_html_e('It looks like something is off and what we were looking for was not found.', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.75"}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="line-height:1.75"><?php esc_html_e('But do not lose heart, there are', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->
...
<p class="letterpress has-playfair-font-family has-x-large-font-size" style="font-style:normal;font-weight:800;letter-spacing:-2px;line-height:0.95"><?php esc_html_e('404 reasons', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size"><?php esc_html_e('that all is ultimately okay!', 'studio-bombay-twenty-six');?></p>
<!-- /wp:paragraph -->
