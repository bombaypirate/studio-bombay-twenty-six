 ...
 * Theme setup.
 */
if ( ! function_exists( 'studio_bombay_twenty_six_setup' ) ) {
	function studio_bombay_twenty_six_setup(): void {
...
add_action( 'after_setup_theme', 'studio_bombay_twenty_six_setup' );

/**
 * Enqueue front-end custom styles.
 */
if ( ! function_exists( 'studio_bombay_twenty_six_enqueue' ) ) {
	function studio_bombay_twenty_six_enqueue(): void {
		wp_enqueue_style(
			'studio-bombay-twenty-six-style',
			get_stylesheet_uri(),
			array(),
...
add_action( 'enqueue_block_assets', 'studio_bombay_twenty_six_enqueue' );

/**
 * Inject the scroll elephant markup into the footer.
 */
if ( ! function_exists( 'studio_bombay_twenty_six_scroll_elephant' ) ) {
	function studio_bombay_twenty_six_scroll_elephant(): void {
		?>
...
add_action( 'wp_footer', 'studio_bombay_twenty_six_scroll_elephant' );

/**
 * Enqueue the scroll elephant script on the front-end.
 */
if ( ! function_exists( 'studio_bombay_twenty_six_elephant_script' ) ) {
	function studio_bombay_twenty_six_elephant_script(): void {
		wp_enqueue_script(
...
add_action( 'wp_enqueue_scripts', 'studio_bombay_twenty_six_elephant_script' );
